...
scut=0.25; %este quita el ruido esta relacionado directamente con el numero de celulas
...
hcut=0.3; %Hay que cambiar el 70% de los elementos para convertirlo en otro edo
...
csi_cut=0.2; %Porcentaje de corte para determinar las celulas que pesan mas 
...
%     csi_hist_norm=csi_hist/max(csi_hist); %Noramliza a 1 para tener solo un parametro de corte
...
%recursividad
[Cells_coords,Pools_coords]=Search_edos_coords(Cells_edos,sis_query,Coordactive);
